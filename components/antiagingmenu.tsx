  ...
  return (
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {/* CTA box */}
        <div className="relative bg-boulder-400 py-10 px-8 md:py-16 md:px-12" data-aos="fade-up">
          ...
          <div className="relative flex flex-col lg:flex-row justify-between items-center">
            ...
            <div className="mb-6 lg:mr-16 lg:mb-0 text-center lg:text-left lg:w-1/2">
              <h3 className="h3 text-white mb-2">Mantente informado!</h3>
              <p className="text-white text-lg">Únete a nuestro newsletter para estar a la última.</p>
            </div>

            {/* CTA form */}
            <form className="w-full lg:w-1/2">
              <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:max-w-none">
                <input type="email" className="w-full appearance-none bg-white border border-thunderbird-400 focus:border-pomegranate-600 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-woodsmoke-600 placeholder-woodsmoke-400" placeholder="Tu mejor email…" aria-label="Your best email…" />
                <a className="btn text-white bg-pomegranate-600 hover:bg-pomegranate-500 shadow" href="#0">Suscribirse</a>
              </div>
              {/* Success message */}
...
//       {antiagingMenu.submenu[antiagingMenu.submenu.length - 1].name}
//       </h3>
//       <img
//         src={antiagingMenu.submenu[antiagingMenu.submenu.length - 1].imageUrl}
//         alt={antiagingMenu.submenu[antiagingMenu.submenu.length - 1].name}
//         className="mb-4 w-48 h-48 object-cover cursor-pointer"
//       />
//     </Link>
//     <div className="services grid grid-cols-4 gap-x-8 gap-y-4">
//       {antiagingMenu.submenu[antiagingMenu.submenu.length - 1].services?.map((service, serviceIndex) => (
//         <Link key={serviceIndex} href={service.servicePath}>
//           <button className="bg-thunderbird-400 hover:bg-pomegranate-500 text-white font-semibold py-2 px-4 rounded w-full">
//             {service.serviceName}
//           </button>
