...
const TratamientosFacialesPage: React.FC = () => {
  ...
  const tratamientosFaciales = esteticaMenu.submenu.filter(submenuItem => submenuItem.name === 'Tratamientos Corporales');

  return (
    <DefaultLayout>
            <Head>
            <title>Tratamientos Corporales - HeartMed</title>
            <meta name="description" content="Explora nuestra amplia gama en tratamientos corporales." />
            <meta property="og:title" content="Tratamientos Corporales - HeartMed" />
            <meta property="og:description" content="Explora nuestra amplia gama en tratamientos corporales." />
            ...
            <script type="application/ld+json">
                ...
                "description": "Explora nuestra amplia gama en tratamientos corporales.",
                // "aggregateRating": {
